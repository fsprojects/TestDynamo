module DynamoDbInMemory.Client.Shared
...
let amazonWebServiceResponse<'a when 'a : (new : unit -> 'a) and 'a :> AmazonWebServiceResponse> () =
    ...
    x.ResponseMetadata <-
        ...
        m.ChecksumAlgorithm <- DynamoDbInMemory.Settings.AmazonWebServiceResponse.ChecksumAlgorithm
        m.ChecksumValidationStatus <- DynamoDbInMemory.Settings.AmazonWebServiceResponse.ChecksumValidationStatus
        m.RequestId <- DynamoDbInMemory.Settings.AmazonWebServiceResponse.RequestId.Invoke()
        m
    x.ContentLength <- DynamoDbInMemory.Settings.AmazonWebServiceResponse.ResponseContentLength
