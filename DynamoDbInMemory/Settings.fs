module DynamoDbInMemory.Settings
...
module Logging =
    ...
    /// <summary>
    /// <para>
    /// DynamodbInMemory uses extensive logging for information and debugging purposes
    ...
    /// </para>
    /// <para>
    /// To overcome this, DynamodbInMemory has a custom log format to differentiate logs from different scopes,
...
module SupressErrorsAndWarnings =
    ...
    ///
    /// <para>
    /// In general, DynamoDbInMemory does not deal with aws account ids. However, there are some request types which
